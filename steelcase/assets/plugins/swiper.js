    ...
    var Swiper = function (container, params) {
        ...
        s.onTouchMove = function (e) {
            ...
            if (!isMoved) {
                ...
                if (s.animating) {
                    s.wrapper.trigger('webkitTransitionEnd transitionend oTransitionEnd');
                }
        ...
        s.getTranslate = function (el, axis) {
            ...
            if (window.WebKitCSSMatrix) {
                ...
                transformMatrix = curStyle.OTransform || curStyle.transform || curStyle.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,');
                ...
                setTransition: function (duration) {
                    ...
                    if (s.params.virtualTranslate && duration !== 0) {
                        ...
                        s.slides.transitionEnd(function () {
                            ...
                            eventTriggered = true;
                            s.animating = false;
                            var triggerEvents = ['webkitTransitionEnd', 'transitionend', 'oTransitionEnd'];
        ...
        s.hashnav = {
            ...
            attachEvents: function (detach) {
                ...
                $(window)[action]('hashchange', s.hashnav.onHashChange);
            },
            setHash: function () {
    ...
    Swiper.prototype = {
        ...
        support: {
            ...
            transforms3d : (window.Modernizr && Modernizr.csstransforms3d === true) || (function () {
                ...
                return ('webkitPerspective' in div || 'OPerspective' in div || 'perspective' in div);
            })(),
    ...
    if (domLib) {
        ...
        if (!('transform' in domLib.fn)) {
            domLib.fn.transform = function (transform) {
                for (var i = 0; i < this.length; i++) {
                    ...
                    elStyle.webkitTransform = elStyle.OTransform = elStyle.transform = transform;
                }
                return this;
            };
        }
        if (!('transition' in domLib.fn)) {
            domLib.fn.transition = function (duration) {
                ...
                for (var i = 0; i < this.length; i++) {
                    var elStyle = this[i].style;
                    elStyle.webkitTransitionDuration = elStyle.OTransitionDuration = elStyle.transitionDuration = duration;
                }
                return this;
            };
        }
